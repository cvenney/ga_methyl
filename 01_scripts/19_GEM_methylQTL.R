...
#19_GEM_methylQTL.R
# conda activate R42
# srun -c 1 --mem 200G --time 7-00:00:00 -p medium -o 18_GEM_methylQTL_%j.log Rscript ./01_scripts/19_GEM_methylQTL.R &
...
snp="11_methylQTL/all_maf0.05_pctind0.75_maxdepth25_cutOff0.7.geno.GEM"
meta="11_methylQTL/cliff_covariates.txt"
pval=0.001
output="11_methylQTL/cliff_methylQTL_results_all.txt"
