...
OVERLAPS_D="10_DML_SNP_overlap_allelefreqs/CD_maf0.05_pctind0.75_maxdepth25_freqCsGs.bed"
METH_N="cliff_pct_meth_matrix_pct_meth_normal_means.txt"
OVERLAPS_N="10_DML_SNP_overlap_allelefreqs/CN_maf0.05_pctind0.75_maxdepth25_freqCsGs.bed"
